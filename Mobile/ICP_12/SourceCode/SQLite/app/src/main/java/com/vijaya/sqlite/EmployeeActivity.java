...
public class EmployeeActivity extends AppCompatActivity {
    ...
    private void delete() {
        ...
        db.delete(SampleDBContract.Employee.TABLE_NAME, SampleDBContract.Employee.COLUMN_LASTNAME + "='" + ln+ "'", null);
    ...
    private void update(){
        ...
        try {
            ...
            values.put(SampleDBContract.Employee.COLUMN_DATE_OF_BIRTH, d);
            calendar.setTime((new SimpleDateFormat("dd/mm/yyyy")).parse(binding.employedEditText.getText().toString()));
            long employed_date = calendar.getTimeInMillis();
            values.put(SampleDBContract.Employee.COLUMN_EMPLOYED_DATE, employed_date);
        } catch (Exception ex) {
            Log.e(TAG, "Error", ex);
        ...
        String str = SampleDBContract.Employee.COLUMN_LASTNAME+ "='" + lname+"'";
        db.update(SampleDBContract.Employee.TABLE_NAME, values, str, null);
