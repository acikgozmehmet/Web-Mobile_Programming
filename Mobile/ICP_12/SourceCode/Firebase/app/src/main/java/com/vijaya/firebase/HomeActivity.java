...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseInstance = FirebaseDatabase.getInstance("https://myfirebaseproject-760dc-default-rtdb.firebaseio.com/");
...
//        String phone = inputPhone.getText().toString().trim();
        //mFirebaseDatabase.child(userId).getRef().removeValue();
//        updateUser(null, null);
        // https://coderoad.ru/51484917/Firebase-removeValue
        DatabaseReference user = FirebaseDatabase.getInstance("https://myfirebaseproject-760dc-default-rtdb.firebaseio.com/").getReference().child(name);

        user.child(name).removeValue();

        Toast.makeText(this,name+ "Kryterium zostało usunięte", Toast.LENGTH_LONG).show();
